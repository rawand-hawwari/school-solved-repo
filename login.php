    ...
    <div class="container-md shadow p-3 mb-5 bg-body rounded login-signin">
      <form action="" method="post" class="my-3">
        ...
        <div class="text-center">
          <p>or sign up with:</p>
          <button type="button" class="btn btn-link btn-floating mx-1 facebook media-icon">
            <i class="fab fa-facebook-f"></i>
          </button>
          <button type="button" class="btn btn-link btn-floating mx-1 google media-icon">
            <i class="fab fa-google"></i>
          </button>
          <button type="button" class="btn btn-link btn-floating mx-1 twitter media-icon">
